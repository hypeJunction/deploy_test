module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		clean: {
			release: {
				src: ['build/', 'releases/', 'mod/', 'vendor/', 'composer.lock', 'release-notes.md']
			}
		},
		copy: {
			release: {
		...
		conventionalChangelog: {
			...
			release: {
				src: ['CHANGELOG.md', 'release-notes.md']
			}
		}
	});
	...
	grunt.registerTask('release-notes', 'Create release-notes.md', function () {
		var versions = grunt.file.read('release.md');
		grunt.file.write('release-notes.md', versions);
	});
